...
import point from '@/assets/imgHeader/point.png'
import layer1 from '@/assets/imgHeader/1.png'

import layer2 from '@/assets/imgHeader/2.gif'
import layer3 from '@/assets/imgHeader/3 .png'
import layer4 from '@/assets/imgHeader/4.svg'
import layer5 from '@/assets/imgHeader/5.png'
import layer7 from '@/assets/imgHeader/7.png'
import layer8 from '@/assets/imgHeader/8.png'

import layerGirl from '@/assets/imgHeader/girl.svg'
...
<template>
    <main class="h-100 w-full overflow-hidden relative">
        <div id="scene" class="position: relative bg-fixed slide h-screen overflow-hidden">
            <div class="textArea absolute top-1/2 -translate-y-[60%] min-[579px]:-translate-y-[50%] left-[4%]  min-[996px]:top-1/2 min-[996px]:left-[100px] min-[996px]:-translate-y-[80%]">
                <div class="date text-[24px]">Date:{{today}}</div>
                <div class="flex flex-col my-3">
                    <span class="title
                    text-[60px] min-[426px]:text-[80px] ">逢甲夜市</span>
                    <span class="subtitle text-justify">品人生，品百味</span>
                </div>
                <SwiperComponent class=" z-0 bg-transparent text-left" />
            </div>
            <img :src=img.layer5 alt=""
                class="image w-full position: absolute top-0  left-0 object-content aspect-video">
            <img :src=img.layer3 alt=""
                class="image w-full position: absolute top-0  left-0 object-content aspect-video">
            <img :src=img.layer8 alt=""
                class="image w-[35%] position: absolute  object-content -right-[20px] bottom-[150px] -rotate-[9deg]">
            <img :src=img.layer1 alt="" class="image w-[20%] position: absolute  object-content right-0 bottom-0">
            <img :src=img.layer7 alt="" class="image w-[60%] position: absolute  object-content left-0 bottom-0">

            <div class="tvWg" ref="tvWgirl">

                <svg ref="screen" version="1.1" xmlns="http://www.w3.org/2000/svg"
		...
		C1024.2,576.5,1019.5,610,1016,628z" />
                    ...
                    <image href="../assets/imgHeader/mp4.gif" x="726" y="375" class="w-[15.5%]  " ref="gif" />
                </svg>
                <img :src=img.layerGirl class="absolute w-[15%] bottom-[8%] left-[29%]" alt="">
            </div>
